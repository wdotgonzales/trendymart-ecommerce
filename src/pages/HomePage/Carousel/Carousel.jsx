            ...
            <section className='bg-gray-200 overflow-hidden block lg:hidden hidden md:block'>
                ...
                <div className='flex justify-center gap-2 pb-3'>
                    <button
                        ...
                        <div
                            className={`${currentSlide === 1 ? 'bg-gray-500' : 'bg-gray-50'} w-[20px] rounded-full h-[0.7em] w-[0.7em]`}>
                        </div>
                    </button>
                    <button
                        ...
                        <div
                            ...
                            className={`${currentSlide === 2 ? 'bg-gray-500' : 'bg-gray-50'} w-[20px] rounded-full h-[0.7em] w-[0.7em]`}>
                        </div>
                    </button>
                    <button
                        onClick={() => handleSlideChange(3)}>
                        <div
                            className={`${currentSlide === 3 ? 'bg-gray-500' : 'bg-gray-50'} w-[20px] rounded-full h-[0.7em] w-[0.7em]`}>
                        </div>
                    </button>
                </div>
            </section >
