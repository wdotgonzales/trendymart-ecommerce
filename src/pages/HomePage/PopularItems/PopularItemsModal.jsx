...
const PopularItemsModal = ({ isQuickLookModalHidden, setIsQuickLookModalHidden }) => {
    ...
    useEffect(() => {
        ...
        setPopularItem(temporaryPopularItems.find((temporaryPopularItem) => param1Value === temporaryPopularItem.id))
    }, [urlParams])
    ...
    return <>
        <div
            ...
            <div className="flex justify-center items-center h-screen mx-6">
                <div className="bg-white max-w-[920px] fixed">
                    {/* Content */}
                    <div className="grid grid-cols-2">
                        <div>
                            <Carousel showArrows={true} showThumbs={false}>
                                <div>
                                    <img src={`${popularItem != null && popularItem.url}`} alt="" />
                                </div>
                                {
                                    popularItem != null && popularItem.moreUrls.map((url, index) => {
                                        return <>
                                            <div key={index}>
                                                <img src={url} alt="" />
                                            </div>
                        ...
                        <div className="m-3">
                            ...
                            <div className="p-3">
                                ...
                                <div className='my-4'>
                                    <Rating key={ratingKey} name="half-rating-read" defaultValue={popularItem != null ? popularItem.rating : 0} precision={0.5} readOnly />
                                </div>
